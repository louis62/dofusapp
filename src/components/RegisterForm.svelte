...
<Fab color="primary" style="margin-top: 1em;" extended on:click={e => register(e)}>S'enregistrer</Fab>
<Fab style="margin-top: 1em;" extended on:click={() => goto('/login')}>Se connecter</Fab>
